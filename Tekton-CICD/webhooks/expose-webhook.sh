...
case $choice in
  1)
    ...
    echo "⚠️  This is only for local testing. GitHub webhook needs public URL."
    echo "Press Ctrl+C to stop port forwarding"
    kubectl port-forward svc/el-github-webhook-listener -n tekton-ci 9090:8080
    ;;
  2)
